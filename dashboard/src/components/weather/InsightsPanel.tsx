...
import { TrendingUp, TrendingDown, Minus, AlertTriangle, Thermometer, Activity } from 'lucide-react'
          ...
          <div className="space-y-3" data-testid="trends-content">
            <div className="flex items-center justify-between" data-testid="temperature-trend">
              ...
              <div className="flex items-center gap-2">
                <TrendIcon trend={insights.trends.temperatureTrend} />
                <span className="font-medium">{getTrendLabel(insights.trends.temperatureTrend)}</span>
              </div>
            </div>
            <div className="flex items-center justify-between" data-testid="humidity-trend">
              ...
              <div className="flex items-center gap-2">
                <TrendIcon trend={insights.trends.humidityTrend} />
                <span className="font-medium">{getTrendLabel(insights.trends.humidityTrend)}</span>
              </div>
            </div>
          </div>
        ) : (
